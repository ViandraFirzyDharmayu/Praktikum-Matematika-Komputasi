def biconditional_logic_case():
    ...
    print(f"Perangkat A: {perangkat_A}, Perangkat B: {perangkat_B}, Hasil: {bikonditional}")
    print("===========================================\n")

def inference_case():
    print("=== Studi Kasus Inferensi ===")
    sensor_gerak = False # Sensor mendeteksi gerakan
    alarm_berbunyi = True # Alarm belum berbunyi
...
def argument_case():
    ...
    klien_puas = True # Klien tidak puas
